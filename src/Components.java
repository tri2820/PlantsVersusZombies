...
class HealthComponent extends Component {
  ...
  void reduceHealth(String event) {
    if (event.equals("collision")) this.health -= this.on_collision_reduce_health;
  }
...
class SpeedComponent extends Component {
  ...
  void SpeedUp(String event) {
    if (event.equals("fasten")) this.step -= step_change; // less delay -> faster
  }

  void SpeedDown(String event) {
    if (event.equals("slowed")) this.step += step_change; // more delay -> longer
  }
...
class DamageComponent extends Component {
  ...
  void SpeedUp(String event) {
    if (event.equals("powered")) this.damage -= this.damage_change; // less delay -> faster
  }

  void SpeedDown(String event) {
    if (event.equals("weaken")) this.damage += this.damage_change; // more delay -> longer
  }
